...
def get_app_info(package_name: str, request: Request):
    ...
    <html>
        ...
        <body>
            ...
            <h1><a href="{quote("obtainium://app/" + obtainium_link)}"><img src="https://raw.githubusercontent.com/ImranR98/Obtainium/main/assets/graphics/badge_obtainium.png" alt="Добавить в obtainium"</img></a></h1>
